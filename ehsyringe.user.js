...
// @icon        https://cdn.jsdelivr.net/gh/EhTagTranslation/EhSyringe@c35c6ba1a8ef01c706020a52c274389e0720925c/src/assets/logo.svg
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                _context2.next = 5;
                return esm_set(key, value, this.store);
...
var GM_ALL_DEFINED = !!GM_getValue && !!GM_setValue && !!GM_deleteValue && !!GM_listValues && !!GM_addValueChangeListener && !!GM_removeValueChangeListener;
...
var GM_ALL_SYNC_DEFINED = !!GM_getValue && !!GM_setValue && !!GM_deleteValue && !!GM_listValues;
...
var introduce_update = injectStylesIntoStyleTag_default()(introduce/* default */.Z, options);
       ...
       /* harmony default export */ var plugin_introduce = (introduce/* default */.Z && introduce/* default.locals */.Z.locals ? introduce/* default.locals */.Z.locals : undefined);
...
var tag_tip_update = injectStylesIntoStyleTag_default()(tag_tip/* default */.Z, tag_tip_options);
       ...
       /* harmony default export */ var plugin_tag_tip = (tag_tip/* default */.Z && tag_tip/* default.locals */.Z.locals ? tag_tip/* default.locals */.Z.locals : undefined);
...
var package_namespaceObject = JSON.parse('{"name":"ehsyringe","displayName":"EhSyringe","version":"2.5.2","description":"E 站注射器，将中文翻译注入到 E 站体内。","author":"EhTagTranslation","scripts":{"start:monkey":"webpack serve --mode=development --env type=user-script","start:ext":"webpack --mode=development --watch --env type=web-ext","start:chrome":"yarn start:ext --env vendor=chrome","start:firefox":"yarn start:ext --env vendor=firefox","build":"webpack --mode=production","build:monkey":"yarn build --env type=user-script","build:ext":"yarn build --env type=web-ext","build:chrome":"yarn build:ext --env vendor=chrome && web-ext build -s dist -a releases -n ehsyringe.chrome.zip -o","build:firefox":"yarn build:ext --env vendor=firefox && web-ext build -s dist -a releases -n ehsyringe.firefox.xpi -o","lint":"eslint ./src/**/*.ts","format":"prettier --ignore-path .gitignore --write .","clean":"rimraf dist releases"},"repository":{"type":"git","url":"git+https://github.com/EhTagTranslation/EhSyringe.git"},"license":"MIT","bugs":{"url":"https://github.com/EhTagTranslation/EhSyringe/issues"},"readme":"https://github.com/EhTagTranslation/EhSyringe","homepage":"https://github.com/EhTagTranslation/EhSyringe","devDependencies":{"@babel/core":"^7.15.0","@babel/plugin-transform-runtime":"^7.15.0","@babel/preset-env":"^7.15.0","@types/chrome":"^0.0.154","@types/escape-html":"^1.0.1","@types/node":"^16.7.1","@types/tampermonkey":"^4.0.2","@types/webextension-polyfill":"^0.8.0","@typescript-eslint/eslint-plugin":"^4.29.2","@typescript-eslint/parser":"^4.29.2","babel-loader":"^8.2.2","copy-webpack-plugin":"^9.0.1","css-loader":"^6.2.0","cssnano":"^5.0.8","eslint":"^7.32.0","eslint-config-prettier":"^8.3.0","eslint-plugin-prettier":"^3.4.1","execa":"^5.1.1","html-webpack-plugin":"^5.3.2","less":"^4.1.1","less-loader":"^10.0.1","postcss":"^8.3.6","postcss-import":"^14.0.2","postcss-loader":"^6.1.1","postcss-preset-env":"^6.7.0","prettier":"^2.3.2","rimraf":"^3.0.2","semver":"^7.3.5","style-loader":"^3.2.1","ts-loader":"^9.2.5","tsconfig-paths-webpack-plugin":"^3.5.1","type-fest":"^2.0.0","typescript":"^4.3.5","web-ext":"^6.3.0","webpack":"^5.51.1","webpack-bundle-analyzer":"^4.4.2","webpack-cli":"^4.8.0","webpack-dev-server":"^4.0.0","webpack-userscript":"^2.5.8","webpack-webextension-plugin":"^0.4.1","yargs":"^17.1.1"},"dependencies":{"core-js":"^3.16.2","emoji-regex":"^9.2.2","escape-html":"^1.0.3","idb-keyval":"^5.1.3","lit-html":"^1.4.1","normalize.css":"^8.0.1","rxjs":"^7.3.0","tslib":"^2.3.1","typedi":"^0.10.0","webextension-polyfill":"^0.8.0"}}');
...
var syringe_update = injectStylesIntoStyleTag_default()(syringe/* default */.Z, syringe_options);
       ...
       /* harmony default export */ var plugin_syringe = (syringe/* default */.Z && syringe/* default.locals */.Z.locals ? syringe/* default.locals */.Z.locals : undefined);
...
var logo = __webpack_require__(7855);
...
var _notification = GM_notification !== null && GM_notification !== void 0 ? GM_notification : function (detailsOrText, ondoneOrTitle, image, onclick) {
  var _a, _b, _c, _d;
...
var _openInTab = GM_openInTab !== null && GM_openInTab !== void 0 ? GM_openInTab : function (url) {
...
var popup_update = injectStylesIntoStyleTag_default()(popup/* default */.Z, popup_options);
       ...
       /* harmony default export */ var plugin_popup = (popup/* default */.Z && popup/* default.locals */.Z.locals ? popup/* default.locals */.Z.locals : undefined);
...
var popup_host_update = injectStylesIntoStyleTag_default()(popup_host/* default */.Z, popup_host_options);
       ...
       /* harmony default export */ var user_script_popup_host = (popup_host/* default */.Z && popup_host/* default.locals */.Z.locals ? popup_host/* default.locals */.Z.locals : undefined);
...
function dragButton(el, click) {
  ...
  var initY = clampY(getNumber("eh-popup-button-y", 0.02) * document.documentElement.clientHeight); // set the element's init position:
...
var parent = __webpack_require__(828);
...
var parent = __webpack_require__(6602);
...
var parent = __webpack_require__(9712);
...
// TODO: remove from `core-js@4`
var $ = __webpack_require__(2109);
var $filterReject = __webpack_require__(2092).filterReject;
var addToUnscopables = __webpack_require__(1223);
...
var $ = __webpack_require__(2109);
var $groupBy = __webpack_require__(1386);
var arraySpeciesConstructor = __webpack_require__(7475);
var addToUnscopables = __webpack_require__(1223);
...
/******/ 	var __webpack_exports__ = __webpack_require__(3947);
/******/ 	
/******/ })()
;
